      ...
      <div className="flex gap-2 mt-4 items-center">
        ...
        {response.intent === "meal" && (
          <>
            <button
              disabled={confirmed}
              className="px-4 py-2.5 rounded-full text-[13px] font-medium transition-opacity duration-300"
              style={{
    ...
    >
      ...
      <div className="relative">
        ...
        {isLoading ? (
          ...
          <ResponseContent response={response} animKey={responseKey} onConfirm={onConfirm} />
        ) : null}
      </div>
    </div>
  );
